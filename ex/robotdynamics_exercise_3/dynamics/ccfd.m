...
M_d = model.dynamics.compute.M(q,qd,[],[],params); % [10X10] Inertia matrix
b_d = model.dynamics.compute.b(q,qd,[],[],params); % [10X1] Nonlinear forces
g_d = model.dynamics.compute.g(q,qd,[],[],params); % [10X1] Gravity forces
