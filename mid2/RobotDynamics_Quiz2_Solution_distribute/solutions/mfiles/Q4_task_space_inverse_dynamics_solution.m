function [ tau ] = Q4_task_space_inverse_dynamics_solution(params, gc, I_r_Fd, I_dr_Fd, I_eul_Fd, I_w_Fd)
...
dw_e = kp * pos_err + kd * vel_err;
desired_qddot = pseudoInverseMat(I_J_F, 0.1) * ...
    (dw_e - I_dJ_F * dq);

tau = M * desired_qddot + b + g;
end